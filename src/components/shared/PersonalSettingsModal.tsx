  ...
  return (
    <form onSubmit={handleSave} className="space-y-5">
      ...
      <div className="relative py-3">
        ...
        <div className="relative flex justify-center"><span className="bg-white dark:bg-slate-900 px-3 text-[10px] font-bold text-indigo-600 uppercase tracking-widest">Đổi mật khẩu</span></div>
      </div>
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 bg-slate-950/70 flex items-center justify-center p-4" onClick={onClose}>
        <div
          className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-2xl max-w-4xl w-full h-[80vh] flex overflow-hidden animate-fade-in"
