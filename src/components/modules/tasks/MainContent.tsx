        ...
        <div className="col-span-1 bg-amber-50/40 dark:bg-amber-500/10 border border-amber-200/50 dark:border-amber-500/35 rounded-2xl p-5 shadow-sm h-full flex flex-col min-h-0">
          ...
          {isNoteLoading ? (
            ...
            <textarea
              ...
              className="w-full h-full flex-1 min-h-0 bg-transparent border-none outline-none focus:ring-0 text-xs text-slate-700 dark:text-slate-300 placeholder:text-slate-400 resize-none font-inter leading-relaxed"
              value={quickNote}
              onChange={handleNoteChange}
            />
          )}
          <div className="text-[10px] text-amber-600/70 dark:text-amber-400/60 text-right mt-2 font-medium shrink-0">
